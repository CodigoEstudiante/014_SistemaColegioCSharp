...
('Configuraciones','\Iconos\Configuracion.png'),
('Usuarios','\Iconos\Usuario.png'),
('Alumnos','\Iconos\Alumnos.png'),
('Docentes','\Iconos\Docentes.png'),
('Cursos','\Iconos\Cursos.png'),
('Matricula','\Iconos\Matricula.png')
...
((SELECT IdMenu FROM MENU WHERE Nombre = 'Usuarios'),'Crear Usuario','frmCrearUsuario'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Usuarios'),'Crear Rol','frmCrearRol'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Usuarios'),'Asignar rol permisos','frmRolPermiso'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Alumnos'),'Crear Alumnos','frmCrearAlumnos'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Alumnos'),'Consulta y Reporte','frmReporteAlumnos'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Docentes'),'Crear Docentes','frmCrearDocentes'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Docentes'),'Agregar Curricula','frmAgregarCurricula'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Docentes'),'Agregar Calificacion','frmAgregarCalificacion'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Cursos'),'Crear Cursos','frmCrearCursos'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Matricula'),'Crear Matricula','frmCrearMatricula'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Matricula'),'Consulta y Reporte','frmReporteMatricula'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Configuraciones'),'Crear Periodo','frmCrearPeriodo'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Configuraciones'),'Crear Nivel Academico','frmCrearNivel'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Configuraciones'),'Crear Grados y Secciones','frmCrearGradoSeccion'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Configuraciones'),'Asignar Grados por Niveles','frmCrearNivelDetalle'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Configuraciones'),'Asignar Cursos por Niveles','frmAsignarCurso'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Configuraciones'),'Asignar Vacantes','frmCrearVacantes'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Configuraciones'),'Crear Horario','frmCrearHorario'),
((SELECT IdMenu FROM MENU WHERE Nombre = 'Configuraciones'),'Asignar Docentes por Cursos','frmAsignarDocente')
